...
const posts = [
  {
    ...
    description:
      "The ocean covers over 70% of Earth's surface, yet much of it remains unexplored. Beneath its waves lies a vast, mysterious world teeming with vibrant marine life, ancient shipwrecks, and ecosystems that defy imagination.",
    imageUrl: "/image1.jpg",
  },
  {
    id: '2',
